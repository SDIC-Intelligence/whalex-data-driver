...
import com.meiya.whalex.sql2dsl.parser.CommentSqlToDslParser;
 ...
 */
public class CommentSqlParser implements ISqlParser<Boolean> {
    ...
    public CommentSqlParser(String sql, DbModuleService service, DatabaseSetting databaseSetting) {
        this.sql = sql;
    ...
    public PageResult executeAndGetPageResult() throws Exception {
        ...
        PageResult pageResult = service.alterTable(databaseSetting, tableSetting, condition);
        return pageResult;
    }
