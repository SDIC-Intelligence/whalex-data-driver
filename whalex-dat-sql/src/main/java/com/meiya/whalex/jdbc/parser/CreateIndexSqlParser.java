...
import com.meiya.whalex.sql2dsl.parser.CreateIndexSqlToDslParser;
 ...
 */
public class CreateIndexSqlParser implements ISqlParser<Boolean> {
    ...
    public CreateIndexSqlParser(String sql, DbModuleService service, DatabaseSetting databaseSetting) {
        this.sql = sql;
    ...
    public PageResult executeAndGetPageResult() throws Exception {
        ...
        PageResult pageResult = service.createIndex(databaseSetting, tableSetting, condition);
        return pageResult;
    }
