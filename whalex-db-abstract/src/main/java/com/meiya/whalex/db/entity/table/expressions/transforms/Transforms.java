 ...
 * under the License.
 */
package com.meiya.whalex.db.entity.table.expressions.transforms;
...
public class Transforms {
  ...
  private static final String NAME_OF_HASH = "hash";

  private static final String NAME_OF_KEY = "key";

  private static final String NAME_OF_RANGE_COLUMNS = "range columns";
  ...
  /** A transform that includes multiple fields in a list. */
  public static final class HashTransform implements Transform {

    private final NamedReference[] fields;
    private final ListPartition[] assignments;

    private HashTransform(NamedReference[] fields) {
      this.fields = fields;
      this.assignments = new ListPartition[0];
    }

    private HashTransform(NamedReference[] fields, ListPartition[] assignments) {
      this.fields = fields;
      this.assignments = assignments;
    }
