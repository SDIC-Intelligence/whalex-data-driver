 ...
 */
@ApiModel(value = "数据集查询报文")
public class DataSetQueryCondition extends BaseQuery {
    ...
    public static DataSetQueryCondition create() {
        return new DataSetQueryCondition();
    }

    public DataSetQueryCondition dbType(String dbType) {
        this.dbType = dbType;
        return this;
    }

    public DataSetQueryCondition role(String role) {
        super.role = role;
        return this;
    }

    public DataSetQueryCondition token(String token) {
        super.token = token;
        return this;
    }

    public DataSetQueryCondition params(QueryParamCondition params) {
        this.params = params;
        return this;
    }

    public static DataSetQueryCondition fromJson(String jsonStr) {
        try {
            return OBJECT_MAPPER.readValue(jsonStr, DataSetQueryCondition.class);
        } catch (IOException e) {
