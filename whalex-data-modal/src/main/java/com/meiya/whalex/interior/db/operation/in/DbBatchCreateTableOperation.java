 ...
 */
@ApiModel("批量根据连接信息创建数据库表请求报文")
@Data
public class DbBatchCreateTableOperation extends BaseQuery {

    private List<SingleCreateTableOperation> operationBatch;

    @Data
    public static class SingleCreateTableOperation {
