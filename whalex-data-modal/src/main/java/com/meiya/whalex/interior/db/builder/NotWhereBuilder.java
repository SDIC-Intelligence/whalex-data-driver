 ...
 */
public class NotWhereBuilder extends NestWhereBuilder {

    private NotWhereBuilder() {
        super(Rel.NOT);
    }

    public static NotWhereBuilder builder() {
        return new NotWhereBuilder();
    }

    public NestWhereBuilder not(Where... subWhere) {
