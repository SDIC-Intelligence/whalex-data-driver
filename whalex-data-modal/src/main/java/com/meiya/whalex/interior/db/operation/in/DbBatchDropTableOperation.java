 ...
 */
@ApiModel("根据连接信息删除据库表请求报文")
@Data
public class DbBatchDropTableOperation extends BaseQuery {

    private List<SingleDropTableOperation> operationBatch;

    @Data
    public static class SingleDropTableOperation {
