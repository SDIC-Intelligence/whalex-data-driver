...
import com.meiya.whalex.db.entity.table.expressions.distributions.Distribution;
import com.meiya.whalex.db.entity.table.expressions.distributions.Distributions.DistributionImpl;
import com.meiya.whalex.db.entity.table.expressions.distributions.Strategy;
...
import com.meiya.whalex.db.entity.table.parttions.ListPartition;
...
public final class MysqlUtils {
  ...
  private static final Pattern PARTITION_INFO_PATTERN =
      Pattern.compile("PARTITION BY \\b(LIST|RANGE|HASH|KEY|RANGE COLUMNS)\\b\\s*\\((.+)\\)");
  ...
  private static final String HASH_PARTITION = "HASH";

  private static final String KEY_PARTITION = "KEY";

  private static final String RANGE_COLUMNS_PARTITION = "RANGE COLUMNS";
