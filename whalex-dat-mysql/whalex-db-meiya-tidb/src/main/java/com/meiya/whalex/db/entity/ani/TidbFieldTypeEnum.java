 ...
 */
public enum TidbFieldTypeEnum implements FieldTypeAdapter {
    ...
    POINT("varchar", ItemFieldTypeEnum.POINT, 100, null, ItemFieldTypeEnum.ParamStatus.MUST, ItemFieldTypeEnum.ParamStatus.NO, false),
    ...
    TidbFieldTypeEnum(String dbFieldType, ItemFieldTypeEnum fieldType, Integer filedLength, Integer fieldDecimalPoint, ItemFieldTypeEnum.ParamStatus dataLength, ItemFieldTypeEnum.ParamStatus dataDecimalPoint, boolean unsigned) {
    ...
    public static TidbFieldTypeEnum findFieldTypeEnum(String fieldTypeStr) {
        TidbFieldTypeEnum result = null;
        ItemFieldTypeEnum fieldType = ItemFieldTypeEnum.findFieldTypeEnum(fieldTypeStr);
        for (TidbFieldTypeEnum fieldTypeEnum : TidbFieldTypeEnum.values()) {
            ...
            if (dbFieldType.equalsIgnoreCase(fieldTypeEnum.dbFieldType)) {
                if (fieldTypeEnum.equals(BaseMySqlFieldTypeEnum.BIT)) {
                    if (fieldLength != null && fieldLength == 1) {
                        result = TidbFieldTypeEnum.BOOLEAN.fieldType;
                    } else {
                    ...
                    if (fieldLength != null && fieldLength == 1) {
                        ...
                        result = TidbFieldTypeEnum.TINYINT.fieldType;
                    }
                } else {
                    result = fieldTypeEnum.fieldType;
                }
