 ...
 */
@DbHelper(dbType = DbResourceEnum.dm, version = DbVersionEnum.DM_7, cloudVendors = CloudVendorsEnum.OPEN)
@Slf4j
public class Dm7ConfigHelper extends BaseDmConfigHelper<QueryRunner, BaseDmDatabaseInfo, BaseDmTableInfo, RdbmsCursorCache> {
}
