 ...
 * @description QlInternalPoint3D
 */
public class QlInternalPoint3D implements QlPoint {
    ...
    public QlInternalPoint3D(int srid, double x, double y, double z) {
        this.srid = srid;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public boolean equals(Object o) {
        if (this == o) {
            ...
            QlInternalPoint3D that = (QlInternalPoint3D)o;
