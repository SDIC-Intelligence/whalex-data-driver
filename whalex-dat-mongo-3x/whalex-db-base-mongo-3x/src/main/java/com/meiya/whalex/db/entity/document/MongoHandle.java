...
public class MongoHandle extends AbstractDbHandler {
    ...
    private MongoAlterTable mongoAlterTable;
    ...
    public MongoAlterTable getMongoAlterTable() {
        return mongoAlterTable;
    }

    public void setMongoAlterTable(MongoAlterTable mongoAlterTable) {
        this.mongoAlterTable = mongoAlterTable;
    }
    ...
    public static class MongoAlterTable {
        ...
        private String addFieldsJson;

        private List<Bson> updateFields;

        private String updateFieldsJson;

        private List<Bson> delFields;

        private String delFieldsJson;
