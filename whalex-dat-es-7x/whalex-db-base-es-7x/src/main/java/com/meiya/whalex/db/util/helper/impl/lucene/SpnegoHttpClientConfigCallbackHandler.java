...
import com.meiya.whalex.db.kerberos.exception.KerberosRuntimeException;
...
public class SpnegoHttpClientConfigCallbackHandler implements HttpClientConfigCallback {
    ...
    private static final String CRED_CONF_NAME = KerberosJaasConfigurationUtil.Module.ES.getName();
    ...
    private static Oid getSpnegoOid() {
        ...
        try {
            ...
            throw new KerberosRuntimeException(gsse);
        }
        return oid;
    }
     ...
     */
    public SpnegoHttpClientConfigCallbackHandler(final String userPrincipalName) {
        this.userPrincipalName = userPrincipalName;
        this.keytabPath = System.getProperty(KerberosEnvConfigurationUtil.JAVA_SECURITY_KRB5_CONF_KEY);
    }
...
//                conf = new KeytabJaasConf(userPrincipalName, keytabPath, enableDebugLogs);
                conf = java.security.AccessController.doPrivileged
