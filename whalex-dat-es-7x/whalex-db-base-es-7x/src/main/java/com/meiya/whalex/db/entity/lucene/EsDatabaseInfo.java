...
public class EsDatabaseInfo extends AbstractDatabaseInfo {
    ...
    /**
     * 华为滚动索引模板是否配置 ism_template
     */
    private boolean openIsmTemplate = true;
    ...
    public boolean isOpenIsmTemplate() {
        return openIsmTemplate;
    }

    public void setOpenIsmTemplate(boolean openIsmTemplate) {
        this.openIsmTemplate = openIsmTemplate;
    }
}
