...
public class HBaseHandler extends AbstractDbHandler {
    ...
    private HBaseUpdate update;

    private HBaseDel delete;
    ...
    private HBaseAlterTable alterTable;
    ...
    public HBaseUpdate getUpdate() {
        return update;
    }

    public void setUpdate(HBaseUpdate update) {
        this.update = update;
    }

    public HBaseDel getDelete() {
        return delete;
    }

    public void setDelete(HBaseDel delete) {
        this.delete = delete;
    }

    public HBaseAlterTable getAlterTable() {
        return alterTable;
    }

    public void setAlterTable(HBaseAlterTable alterTable) {
     ...
     * HBase 更新实体类
     */
    public static class HBaseUpdate {
        /**
         * 入库数据
         */
        private List<Put> putList;
     ...
     */
    @Data
    public static class HBaseDel {
        /**
         * 入库数据
         */
        private List<Delete> deleteList;

        private List<String> deleteStrList;
    ...
    @Data
    public static class HBaseAlterTable {

        /**
         * 新增列簇
         */
        private List<HColumnDescriptor> addColumns;

        /**
         * 删除列簇
         */
        private List<byte[]> delColumns;
    }
}
